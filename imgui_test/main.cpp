...
int main(int argc, char* argv[])
{
    ...
    io.Fonts->AddFontFromFileTTF("/home/viacheslav/Documents/Project/cpp_sandbox/imgui_test/resources/DejaVuSansMono.ttf",
...
void CreateX11Window()
{
    ...
    g_window = XCreateWindow(g_display, RootWindow(g_display, vi->screen),
        0, 0, 230, 420, 0, vi->depth, InputOutput,
        vi->visual,
    ...
    hints.min_width = hints.max_width = 230;
    hints.min_height = hints.max_height = 420;
